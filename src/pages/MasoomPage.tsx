...
const MasoomPage = () => {
  ...
  const t = {
    ...
    hi: {
      ...
      cyberbullyingDefinition: "साइबर बुलिंग तब होती है जब कोई व्यक्ति फोन, कंप्यूटर या सोशल मीडिया का उपयोग करके किसी दूसरे व्यक्ति को नुकसान पहुंचाता, शर्मिंदा करता या डराता है।",
      cyberbullyingTypes: ["गुस्से भरे संदेश या टिप्पणियां भेजना", "बिना अनुमति शर्मनाक फोटो या वीडियो साझा करना", "ऑनलाइन अफवाहें या झूठ फैलाना", "जानबूझकर किसी को ऑनलाइन ग्रुप से बाहर करना"],
      ...
      groomingWarnings: ["लगातार चैटिंग और ध्यान", "व्यक्तिगत जानकारी मांगना", "बातचीत को गुप्त रखना चाहना", "फोटो या वीडियो मांगना"],
      phishingTricks: "फिशिंग ट्रिक्स",
      phishingDesc: "आपकी जानकारी चुराने के लिए नकली संदेश",
      phishingTypes: ["फिशिंग: नकली ईमेल/वेबसाइट", "स्मिशिंग: नकली टेक्स्ट संदेश", "विशिंग: नकली फोन कॉल", "कैटफिशिंग: नकली ऑनलाइन प्रोफाइल"],
      safetyRules: "सरल सुरक्षा नियम",
      doList: "✅ करें",
      dontList: "❌ न करें",
      doItems: ["केवल वास्तविक मित्रों से चैट करें", "यदि कुछ गलत लगे तो किसी विश्वसनीय वयस्क को बताएं", "पासवर्ड निजी रखें", "बुरे लोगों को ब्लॉक और रिपोर्ट करें", "कुछ भी पोस्ट करने से पहले सोचें"],
      dontItems: ["व्यक्तिगत जानकारी साझा न करें", "इंटरनेट से अजनबियों से न मिलें", "अज्ञात लोगों से ईमेल न खोलें", "साइबर बुलीज़ का जवाब न दें", "अज्ञात फाइलें या ऐप्स डाउनलोड न करें"],
      rememberThis: "यह याद रखें!",
      internetWarning: "🌐 इंटरनेट एक सार्वजनिक स्थान की तरह है - आप जो कुछ भी देखते हैं वह सब वास्तविक नहीं है!",
      ...
      csaSubtitle: "समझना, रोकथाम, और सुरक्षित रहना",
      whatIsCSA: "बाल यौन शोषण (CSA) क्या है?",
      csaDefinition: "CSA तब होता है जब कोई वयस्क या बड़ा व्यक्ति बच्चे के साथ यौन चीजें करता है। यह गलत है और कानून के खिलाफ है।",
      keyFacts: "मुख्य तथ्य",
      keyFactsList: ["लड़कियां और लड़के दोनों शिकार हो सकते हैं", "85% ऐसे लोगों के साथ होता है जिन्हें आप जानते हैं", "सबसे संवेदनशील उम्र: 3-8 और 11-15 साल", "कई बच्चे इसकी रिपोर्ट नहीं करते"],
      typesOfAbuse: "दुर्व्यवहार के प्रकार",
      abuseTypes: ["संपर्क: अनुचित स्पर्श", "गैर-संपर्क: अनुचित चित्र दिखाना", "ऑनलाइन: अनुचित संदेश भेजना", "ग्रूमिंग: नुकसान पहुंचाने के लिए नकली भरोसा बनाना"],
      warningSigns: "चेतावनी संकेत",
      howYouFeel: "आप कैसा महसूस कर सकते हैं",
      feelingsList: ["अचानक डर या चिंता", "छुआ जाना नहीं चाहना", "अक्सर उदास या गुस्सा महसूस करना", "सोने में समस्या", "स्कूल नहीं जाना चाहना"],
      physicalSigns: "शारीरिक संकेत",
      physicalSignsList: ["निजी अंगों में दर्द", "बार-बार पेट दर्द", "बहुत ज्यादा या बहुत कम खाना", "चलने या बैठने में समस्या", "अक्सर बीमार पड़ना"],
      behaviorChanges: "व्यवहार में बदलाव",
      behaviorChangesList: ["बहुत शांत या आक्रामक हो जाना", "कुछ लोगों के आस-पास नहीं रहना चाहना", "ऐसे 'राज' होना जो नहीं बता सकते", "बहुत बड़े या छोटे की तरह काम करना", "खुद को नुकसान पहुंचाना"],
      bodySafetyRules: "शरीर सुरक्षा नियम",
      yourBodyBelongs: "आपका शरीर आपका है!",
      bodyRights: ["आपको अवांछित स्पर्श के लिए 'नहीं' कहने का अधिकार है", "अपनी भावनाओं पर भरोसा करें", "कोई भी आपके निजी अंगों को नहीं छू सकता", "कोई भी आपसे उनके निजी अंगों को छूने के लिए नहीं कह सकता", "आपको कभी भी 'शरीर के राज' नहीं रखने चाहिए"],
      ifUncomfortable: "अगर कोई आपको असहज महसूस कराए",
      uncomfortableActions: ["जोर से और स्पष्ट रूप से 'नहीं' कहें", "उस व्यक्ति से दूर हो जाएं", "तुरंत किसी विश्वसनीय वयस्क को बताएं", "तब तक बताते रहें जब तक कोई आप पर विश्वास न करे", "याद रखें: यह कभी आपकी गलती नहीं है!"],
      pocsAct: "POCSO अधिनियम",
      pocsaDescription: "POCSO अधिनियम 2012 18 साल से कम उम्र के सभी बच्चों को यौन शोषण से बचाता है।",
      whatItCovers: "यह क्या कवर करता है",
      pocsoCoverage: ["यौन हमला", "गंभीर यौन हमला", "यौन उत्पीड़न", "बाल पोर्नोग्राफी"],
      yourRights: "आपके अधिकार",
      rightsList: ["पुलिस आपकी मदद करेगी", "आपकी पहचान निजी रहेगी", "आप घर पर बयान दे सकते हैं", "अदालत आप पर विश्वास करेगी"],
      ...
      pledgeItems: ["आपको व्यक्तिगत सुरक्षा के बारे में सिखाकर", "जब आपको मदद की जरूरत हो तो सुनकर", "आपके स्कूल और पड़ोस को सुरक्षित बनाकर", "किसी भी बच्चे की मदद करके जिसे जरूरत हो"],
      
      childlineIndia: "चाइल्डलाइन इंडिया",
      childlineDesc: "बच्चों के लिए 24/7 हेल्पलाइन",
      emergencyServices: "आपातकालीन सेवाएं",
      emergencyDesc: "पुलिस, फायर, मेडिकल इमरजेंसी",
      ...
      rememberWarning: "अगर कोई आपको चोट पहुंचाता है या असहज महसूस कराता है, तो यह आपकी गलती नहीं है! अपने माता-पिता, शिक्षक या स्कूल काउंसलर जैसे किसी विश्वसनीय वयस्क को बताएं।"
    }
  };

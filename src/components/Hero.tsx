...
import WhatWeDoScroller from "@/components/WhatWeDoScroller";
import ProjectCategoriesSection from "@/components/ProjectCategoriesSection";
import { useAuth } from "@/hooks/useAuth";
import { BarChart3, Users, Shield, AlertTriangle, TrendingUp, FileText, Bell, Settings } from "lucide-react";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="text-center mt-12">
            <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-8 text-white">
              <h3 className="text-2xl font-bold mb-4">Ready to Transform Student Mental Health Support?</h3>
              <p className="text-blue-100 mb-6 max-w-2xl mx-auto">
                Join leading educational institutions in providing comprehensive, data-driven mental health support for your students.
              </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="bg-white border-teal-100 shadow-sm hover:shadow-md transition-shadow duration-300">
          <CardContent className="flex flex-col items-center justify-center py-8">
            ...
            <Link to="/assessment">
              <Button className="bg-teal-500 hover:bg-teal-600 text-white px-6">Take Assessment</Button>
            </Link>
          </CardContent>
        </Card>
        <Card className="bg-white border-blue-100 shadow-sm hover:shadow-md transition-shadow duration-300">
          <CardContent className="flex flex-col items-center justify-center py-8">
            ...
            <p className="text-gray-600 mb-4 text-center">Explore articles, videos, and activities for wellbeing and support.</p>
            <Link to="/resources">
              <Button variant="outline" className="border-blue-300 text-blue-700 hover:bg-blue-50 px-6">Browse Resources</Button>
            </Link>
          </CardContent>
        </Card>
        <Card className="bg-white border-purple-100 shadow-sm hover:shadow-md transition-shadow duration-300">
          <CardContent className="flex flex-col items-center justify-center py-8">
            <div className="text-3xl mb-4">👥</div>
            <h3 className="text-lg font-semibold mb-2">Contact Counselor</h3>
            <p className="text-gray-600 mb-4 text-center">Reach out to a school counselor for confidential support and guidance.</p>
            <Link to="/contact">
              <Button variant="outline" className="border-purple-300 text-purple-700 hover:bg-purple-50 px-6">Contact Counselor</Button>
            </Link>
          </CardContent>
        </Card>
      </div>

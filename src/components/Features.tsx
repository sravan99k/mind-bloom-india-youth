...
const Features = () => {
  ...
  return (
    <div className="bg-white">
      ...
      <div className="w-full flex flex-col items-center justify-center py-10 bg-gradient-to-r from-teal-50 to-blue-50 border-b border-blue-100 mb-8">
        {/* SVG Illustration */}
        ...
        <h2 className="mt-4 text-2xl font-bold text-teal-800">Your Mind Matters</h2>
